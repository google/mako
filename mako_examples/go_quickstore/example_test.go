...
// (http://github.com/google/mako/docs/GUIDE.md#authentication) and run the
// microservice (http://github.com/google/mako/docs/GUIDE.md#microservice).
package main
...
func TestPerformance(t *testing.T) {
	...
	// http://github.com/google/mako/docs/GUIDE.md#data.
	...
	// http://github.com/google/mako/docs/GUIDE.md#run-metadata.
	...
	//
	// Read more about analyzers at http://github.com/google/mako/docs/CONCEPTS.md#analyzers.
