...
`
  ...
  https://github.com/google/mako/examples/benchmark_info/create_benchmark.config.
...
`
  ...
  The text-proto file at the specified path should be in the same form as
  https://github.com/google/mako/examples/benchmark_info/update_benchmark.config.
...
# FIND FULL DOCUMENTATION OF BenchmarkInfo AT https://github.com/google/mako/spec/proto/mako.proto
#
