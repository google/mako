#ifndef TESTING_PERFORMANCE_PERFGATE_INTERNAL_CXX_ANALYZER_OPTIMIZER_H_
#define TESTING_PERFORMANCE_PERFGATE_INTERNAL_CXX_ANALYZER_OPTIMIZER_H_
...
#endif  // TESTING_PERFORMANCE_PERFGATE_INTERNAL_CXX_ANALYZER_OPTIMIZER_H_
