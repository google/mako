#ifndef TESTING_PERFORMANCE_PERFGATE_INTERNAL_CXX_PROTO_CACHE_H_
#define TESTING_PERFORMANCE_PERFGATE_INTERNAL_CXX_PROTO_CACHE_H_
...
#endif  // TESTING_PERFORMANCE_PERFGATE_INTERNAL_CXX_PROTO_CACHE_H_
