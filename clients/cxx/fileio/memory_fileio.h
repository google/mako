#ifndef TESTING_PERFORMANCE_PERFGATE_CLIENTS_CXX_FILEIO_MEMORY_FILEIO_H_
#define TESTING_PERFORMANCE_PERFGATE_CLIENTS_CXX_FILEIO_MEMORY_FILEIO_H_
...
#endif  // TESTING_PERFORMANCE_PERFGATE_CLIENTS_CXX_FILEIO_MEMORY_FILEIO_H_
