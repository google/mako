...
// ============
//
// This library defines the following matchers in the ::mako namespace:
//
...
// functions in the ::mako::proto namespace:
//
...
//   using ::mako::EquivToProto;
//   using ::mako::proto::Approximately;
//   using ::mako::proto::Partially;
//   using ::mako::proto::WhenDeserialized;
//
...
#ifndef CXX_TESTING_PROTOCOL_BUFFER_MATCHERS_H_
#define CXX_TESTING_PROTOCOL_BUFFER_MATCHERS_H_
...
#endif  // CXX_TESTING_PROTOCOL_BUFFER_MATCHERS_H_
