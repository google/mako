...
#ifndef CXX_INTERNAL_STORAGE_CLIENT_OAUTH_TOKEN_PROVIDER_H_
#define CXX_INTERNAL_STORAGE_CLIENT_OAUTH_TOKEN_PROVIDER_H_
...
#endif  // CXX_INTERNAL_STORAGE_CLIENT_OAUTH_TOKEN_PROVIDER_H_
