...
#ifndef CXX_INTERNAL_STORAGE_CLIENT_GOOGLE_OAUTH_FETCHER_H_
#define CXX_INTERNAL_STORAGE_CLIENT_GOOGLE_OAUTH_FETCHER_H_
...
#endif  // CXX_INTERNAL_STORAGE_CLIENT_GOOGLE_OAUTH_FETCHER_H_
