...
using ::mako::helpers::quickstore::IsOK;
using ::mako::helpers::quickstore::Quickstore;
using ::mako::helpers::quickstore::QuickstoreInput;
using ::mako::helpers::quickstore::QuickstoreOutput;
...
TEST(QuickstoreTest, RunAnalyzers) {
  ...
  *wda_query->add_tags() = "analyzer_example";
  ...
  EXPECT_EQ(mako::helpers::quickstore::QuickstoreOutput::ANALYSIS_FAIL,
            output.status());
}
