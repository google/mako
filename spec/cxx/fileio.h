#ifndef TESTING_PERFORMANCE_PERFGATE_SPEC_CXX_FILEIO_H_
#define TESTING_PERFORMANCE_PERFGATE_SPEC_CXX_FILEIO_H_
...
#endif  // TESTING_PERFORMANCE_PERFGATE_SPEC_CXX_FILEIO_H_
